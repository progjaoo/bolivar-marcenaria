      ...
      <div className="container mx-auto px-6 md:px-12">
        <div className="flex flex-col md:flex-row items-center gap-12 md:gap-20">
          ...
          >
            ...
            <h2 className="text-3xl md:text-5xl font-serif leading-tight mb-8 text-luxury-graphite">
              Uma trajetória de paixão e <br className="hidden lg:block" /> excelência na marcenaria
            </h2>
